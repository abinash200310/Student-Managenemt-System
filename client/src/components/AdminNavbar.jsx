      ...
      <Wrapper>
        ...
        <Right>
          <MenuItem onClick={AddStudent}>
            <PersonAdd style={{ color: "#7A5BC7" }} />
          </MenuItem>
          <MenuItem onClick={AddFaculty}>
            <HowToReg style={{ color: "#7A5BC7" }} />
          </MenuItem>
          <MenuItem onClick={AddSubject}>
            <LibraryAdd style={{ color: "#7A5BC7" }} />
          </MenuItem>
          <MenuItem onClick={GetStudent}>
            <Person style={{ color: "#7A5BC7" }} />
          </MenuItem>
          <MenuItem onClick={GetFaculty}>
            <Group style={{ color: "#7A5BC7" }} />
          </MenuItem>
          <MenuItem onClick={GetSubject}>
            <LibraryBooks style={{ color: "#7A5BC7" }} />
          </MenuItem>
          <MenuItem onClick={logoutHandler}>
            <ExitToApp style={{ color: "#7A5BC7" }} />
          </MenuItem>
        </Right>
      </Wrapper>
    </Container>
