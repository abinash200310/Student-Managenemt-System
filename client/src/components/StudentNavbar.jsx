...
const Container = styled.div`
  width: 100vw;
  display: flex;
  border-bottom: 0.5px solid #7a5bc7;
`;
    ...
    <Container>
      <Wrapper>
        ...
        <Right>
          ...
          <MenuItem>
            <Person onClick={updateProfile} style={{ color: "#7A5BC7" }} />
          </MenuItem>
          <MenuItem>
            <Dashboard onClick={marksList} style={{ color: "#7A5BC7" }} />
          </MenuItem>
          <MenuItem>
            <VpnKey onClick={updatePassword} style={{ color: "#7A5BC7" }} />
          </MenuItem>
          <MenuItem>
            <Search onClick={searchStudent} style={{ color: "#7A5BC7" }} />
          </MenuItem>
          <MenuItem>
            <Group onClick={attendance} style={{ color: "#7A5BC7" }} />
          </MenuItem>
          <MenuItem>
            <Ballot onClick={subjectList} style={{ color: "#7A5BC7" }} />
          </MenuItem>
          <MenuItem>
            <Chat onClick={chatList} style={{ color: "#7A5BC7" }} />
            <IconBadge>{student.newerChats.length}</IconBadge>
          </MenuItem>
          <MenuItem>
            <ExitToApp onClick={logoutHandler} style={{ color: "#7A5BC7" }} />
          </MenuItem>
        </Right>
      </Wrapper>
    </Container>
