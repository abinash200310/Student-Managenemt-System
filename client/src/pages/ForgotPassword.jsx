...
const ForgotPassword = () => {
  ...
  const submitOtpHandler = (e) => {
    ...
    if (user === "student") {
      dispatch(
        submitOTPStudent({ email, otp, newPassword, confirmNewPassword })
      );
      alert.success("Please login with New Password");
      navigate("/");
    } else if (user === "faculty") {
      dispatch(
        submitOTPFaculty({ email, otp, newPassword, confirmNewPassword })
      );
      alert.success("Please login with New Password");
      navigate("/");
    }
  ...
  return (
    <>
      {!helper ? (
        <Container>
          <ProfileBox>
            <ProfileHeader>Forgot Password</ProfileHeader>
            <ProfileForm
