...
exports.addAdmin = async (req, res, next) => {
  try {
    ...
    if (department === "BSc,.(Computer Science)") {
      departmentHelper = "01";
    } else if (department === "BSc,.(Physics)") {
      departmentHelper = "02";
    } else if (department === "BSc,.(Chemistry)") {
      departmentHelper = "03";
    } else if (department === "Mechanical") {
      departmentHelper = "04";
    } else if (department === "BSc,.(Mathematics)") {
      departmentHelper = "05";
    } else if (department === "BSc,.(Agriculture)") {
      departmentHelper = "06";
    } else {
      departmentHelper = "00";
    }
